@REQ_NE-1387
Feature: User doesn't log in and search schedule at Home Page
  ...
  Scenario: Home Page - 1.1 Verify search by Point to Point type
    ...
    Then User can see greater than or equal "2" results

  @UseScheduleBox @Homepage @stage
  Scenario: Home Page - 1.2 Verify search by Vessel type
  ...
  @UseScheduleBox @Homepage @stage
  Scenario: Home Page - 1.3 Verify search by Port type
  ...
  @UseScheduleBox @Homepage @stage
  Scenario: Home Page - 1.4 Verify search by Long Range type
